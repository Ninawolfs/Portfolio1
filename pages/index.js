      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 mx-auto md:text-xl">
              Hi there! <br /> I am a passionate front-end developer with a keen
              ...
              React JS, Tailwind and many more! I am always looking for new
              challenges to improve my skills. I am comfortable working with
              modern web development tools such as React, Bootstrap, and Git,
              and I am always eager to learn more. I believe that great design
              ...
              visually appealing and functional. If you are looking for a
              front-end developer who is passionate, driven, and eager to learn,
              I would love to chat and see how we can work together.
            </p>
          </div>
        ...
        <section>
          <div>
            ...
            <div>
              ...
              <ul>
                <li>
                  ...
                  specific needs, whether you are looking for a simple landing
                ...
                <li>
                  ...
                  : I can help you improve your websites visibility and ranking
            ...
            <p>
              Whether you are a small business looking to establish an online
              ...
              <br />
              Let us work together to build a website that meets your needs and
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <p className="py-2">
                ...
                development tools and techniques, it is possible to create
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800">
              ...
              Let us work <span className="text-teal-500">together</span> to
